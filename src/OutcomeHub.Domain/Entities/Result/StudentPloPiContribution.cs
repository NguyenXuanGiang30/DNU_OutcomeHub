...
public sealed class StudentPloPiContribution
{
    private StudentPloPiContribution()
    {
    }
    ...
    public Guid StudentPloResultId { get; private set; }
    ...
    public string? GateFailureReason { get; private set; }
    ...
    public StudentPloResult StudentPloResult { get; private set; } = null!;
    public StudentPiResult StudentPiResult { get; private set; } = null!;
    public OutcomeHub.Domain.Entities.Measurement.SnapshotPiPloWeight SnapshotPiPloWeight { get; private set; } = null!;
